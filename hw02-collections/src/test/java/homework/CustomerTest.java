...
class CustomerTest {
    ...
    @Test
    @DisplayName("Check that Customer works well")
    ...
    @DisplayName("Customer Object as a key map")
    ...
    @DisplayName("Ascending sorting based on score field")
    ...
    @Test
    // Возвращание в обратном порядке
